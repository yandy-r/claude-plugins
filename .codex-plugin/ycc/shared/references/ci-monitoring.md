...
`~/.codex/plugins/ycc/shared/scripts/ci-monitor.sh`. This document and
...
- `~/.codex/plugins/ycc/shared/scripts/ci-monitor.sh` — loop execution script
- `~/.codex/plugins/ycc/skills/git-workflow/SKILL.md` — Phase 6 (CI monitoring loop)
- `~/.codex/plugins/ycc/skills/prp-pr/SKILL.md` — Phase 7 (CI monitoring loop)
