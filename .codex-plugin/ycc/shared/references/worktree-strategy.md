...
| Property   | Value                                                                 |
| ---------- | --------------------------------------------------------------------- |
| Path       | `<repo-root>/.codex/worktrees/<repo>-<feature>/`                     |
...
`<repo-root>/.codex/worktrees/` so each runtime stays inside the managed
...
The feature worktree remains at `<repo-root>/.codex/worktrees/<repo>-<feature>/` after the
...
documented in `ycc/settings/rules/AGENTS.md:207–224`.
