...
3. **Create team** - Use create an agent group with name `sc-[feature-name]`
4. **Create tasks** - Use record the task to create 4 research tasks
5. **Spawn in parallel** - Use a single message with 4 parallel agent runs, each with `team_name` and `name`
6. **Monitor progress** - Use the task tracker to check when all tasks complete
...
10. **Clean up team** - Use close the agent group
...
| ----------------------- | --------------------------- | --------- | ------ |
| architecture-researcher | `codebase-research-analyst` | Yes       | sonnet |
| patterns-researcher     | `codebase-research-analyst` | Yes       | sonnet |
| integration-researcher  | `codebase-research-analyst` | Yes       | sonnet |
| docs-researcher         | `codebase-research-analyst` | Yes       | sonnet |
