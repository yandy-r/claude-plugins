...
#                              Default: ${HOME}/.codex/plugins/marketplaces
#   YCC_MCP_LIBRARY_DOC      — path to an MCP library AGENTS.md
#                              Default: ${HOME}/.codex/mcp-library/AGENTS.md
#
...
# ---------------------------------------------------------------------------
MARKETPLACE_DIR="${YCC_MCP_MARKETPLACE_DIR:-${HOME}/.codex/plugins/marketplaces}"
MCP_LIBRARY_DOC="${YCC_MCP_LIBRARY_DOC:-${HOME}/.codex/mcp-library/AGENTS.md}"
