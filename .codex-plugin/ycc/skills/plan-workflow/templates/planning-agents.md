...
3. **Create tasks** - Use record the task to create 3 analysis tasks
4. **Spawn in parallel** - Use a single message with 3 parallel agent runs, each with `team_name` and `name`
