...
description: Conduct strategic multi-perspective research using the Asymmetric Research
  ...
  futurist, and negative-space perspectives. Use for comprehensive research on complex
  topics requiring diverse viewpoints, competitive analysis, or strategic intelligence
  gathering.
---
...
**CRITICAL**: Deploy all 8 persona agents in a **SINGLE message** with **MULTIPLE parallel agent runs**.
...
**CRITICAL**: Deploy both analysis agents in a **SINGLE message** with **MULTIPLE parallel agent runs**.
...
**CRITICAL**: Deploy all 4 strategic analysis agents in a **SINGLE message** with **MULTIPLE parallel agent runs**.
