---
name: visual-recap
description: Turn a finished change — a git range, branch, or tracked working-tree
  diff — into a LOCAL-ONLY interactive visual recap (annotated diffs, file map, schema/API
...
~/.codex/plugins/ycc/shared/scripts/visual-recap-collect.sh $ARGUMENTS
```
