...
- Feature docs: ~/.codex/file-templates/feature-doc.template.md
- AGENTS.md: ~/.codex/file-templates/agents.template.md
- Architecture docs: ~/.codex/file-templates/arch.template.md
- API docs: ~/.codex/file-templates/api.template.md
...
3. Update or create documentation if appropriate:
   ...
   - AGENTS.md: Only if critically needed in specific directory (RARELY)
...
- Read the reference BEFORE writing your commit message: ~/.codex/plugins/ycc/skills/git-workflow/templates/commit-types.md
- Validate your commit message BEFORE committing:
  ```bash
  ~/.codex/plugins/ycc/skills/git-workflow/scripts/validate-commit.sh "<your-commit-message>"
````
...
Refer to: ~/.codex/plugins/ycc/skills/git-workflow/templates/documentation-decision.md
...
- API docs: ~/.codex/file-templates/api.template.md
- Feature docs: ~/.codex/file-templates/feature-doc.template.md (if needed)
...
- Do NOT create feature docs or AGENTS.md updates
...
2. **Consider AGENTS.md update** - IF this is a critical pattern for the specific directory
   - Update [directory]/AGENTS.md if this pattern MUST be followed
...
**Command**: Single agent run with one docs-git-committer agent
...
**CRITICAL**: Deploy ALL agents in SINGLE message with MULTIPLE parallel agent runs

**Example**:

```

[Single message with 3 parallel agent runs]
