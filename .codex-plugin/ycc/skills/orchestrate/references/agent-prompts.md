...
7. Mark your task complete with update the task tracker (set status to completed)
```
...
1. Check the task tracker for your assigned task
2. Claim with update the task tracker (status=in_progress, owner=your name)
3. Read context files, implement, share findings, validate
4. Mark complete with update the task tracker (status=completed)
