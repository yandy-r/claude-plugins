...
- `~/.codex/plugins/ycc/shared/references/goal-pairing.md` — shared `/goal` pairing contract (transcript-output rules, condition skeleton, caveats).
