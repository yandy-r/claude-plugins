...
Dispatch **`ycc:prp-researcher`** via the blocking **`Task`** tool, in **dual (market + codebase) mode**, to investigate:
...
`${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/standalone-dispatch.md` for the `Task`
