...
- `docs/prps/plans/<name>.plan.md` (from `ycc:prp-plan`)
- `docs/plans/<feature>/parallel-plan.md` (from `ycc:parallel-plan` / `ycc:plan-workflow`)
- `docs/plans/<feature>/shared.md` (from `ycc:plan-workflow`)
