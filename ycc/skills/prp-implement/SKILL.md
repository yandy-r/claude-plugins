...
2. **Interactive failure prompts**: parallel/team batch failures raise AskUserQuestion that `/goal` cannot answer; loop stalls. Pair with auto mode but expect manual intervention on batch failures.
