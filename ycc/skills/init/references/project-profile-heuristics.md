...
| Key                       | Meaning                                                                                    |
| ------------------------- | ------------------------------------------------------------------------------------------ |
| `has_claude_md`           | `CLAUDE.md` exists at the project root                                                     |
| `has_agents_md`           | `AGENTS.md` exists at the project root                                                     |
| `agents_md_is_pointer`    | True if the existing `AGENTS.md` is ≤40 lines and references `CLAUDE.md` (pointer pattern) |
