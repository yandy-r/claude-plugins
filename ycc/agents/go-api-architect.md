...
description: "Use this agent when you need to design, develop, review, or improve Go/Golang APIs. This includes creating new REST APIs from scratch, refactoring existing Go codebases, implementing microservices, adding authentication/authorization, optimizing performance, setting up testing strategies, creating API documentation, or solving complex architectural problems in Go applications. The agent excels at both hands-on coding and high-level system design.\n\nExamples:\n<example>\nContext: User needs help building a new REST API in Go\nuser: \"I need to create a REST API for a user management system with authentication\"\nassistant: \"I'll use the go-api-architect agent to help design and implement this API with proper authentication, following Go best practices.\"\n<commentary>\nSince the user needs to build a Go REST API with authentication, use the go-api-architect agent which specializes in Go API development with security implementation.\n</commentary>\n</example>\n<example>\nContext: User has written Go API code and wants it reviewed\nuser: \"I've just implemented a new endpoint for bulk user creation. Can you review it?\"\nassistant: \"Let me use the go-api-architect agent to review your bulk user creation endpoint implementation.\"\n<commentary>\nThe user has recently written Go API code that needs review, so use the go-api-architect agent to analyze the code for best practices, performance, and security.\n</commentary>\n</example>\n<example>\nContext: User needs help with Go API performance issues\nuser: \"My Go API is running slowly when handling concurrent requests\"\nassistant: \"I'll engage the go-api-architect agent to analyze and optimize your API's concurrent request handling.\"\n<commentary>\nPerformance optimization for Go APIs requires specialized knowledge, so use the go-api-architect agent to diagnose and fix the concurrency issues.\n</commentary>\n</example>"
model: opus
color: blue
---
