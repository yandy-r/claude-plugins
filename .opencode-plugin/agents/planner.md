...
1. A top-level `## Worktree Setup` block after the summary and before the first batch
   or phase. Structure per `.opencode-plugin/skills/_shared/references/worktree-strategy.md` §2.
...
Cross-reference `.opencode-plugin/skills/_shared/references/worktree-strategy.md` in your plan's
