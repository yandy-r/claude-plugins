...
description: 'Prepare and cut a GitHub release for any project — detects toolchain,
  ...
  release CI. Emits commands; never auto-publishes. External-project counterpart to
  /bundle-release. Usage: [version] [--arch=list] [--os=list] [--ci[=generate|audit]]
  [--platform=name] [--skip-notes] [--dry-run]'
---
...
Never auto-commits, pushes, or publishes. Use `/bundle-release` for this repo's
