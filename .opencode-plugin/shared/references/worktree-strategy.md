...
| Property   | Value                                                                 |
| ---------- | --------------------------------------------------------------------- |
| Path       | `<repo-root>/.config/opencode/worktrees/<repo>-<feature>/`                     |
...
`<repo-root>/.config/opencode/worktrees/` so each runtime stays inside the managed
...
The feature worktree remains at `<repo-root>/.config/opencode/worktrees/<repo>-<feature>/` after the
