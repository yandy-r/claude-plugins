...
`~/.config/opencode/shared/scripts/ci-monitor.sh`. This document and
...
- `~/.config/opencode/shared/scripts/ci-monitor.sh` — loop execution script
- `~/.config/opencode/skills/git-workflow/SKILL.md` — Phase 6 (CI monitoring loop)
- `~/.config/opencode/skills/prp-pr/SKILL.md` — Phase 7 (CI monitoring loop)
