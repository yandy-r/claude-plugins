...
# path contains <repo-root>/.config/opencode/worktrees/<repo-name>-<feature-slug>.
#
# Output:
...
Output:
  Markdown table of matching worktrees under <repo-root>/.config/opencode/worktrees/<repo>-<feature>/
