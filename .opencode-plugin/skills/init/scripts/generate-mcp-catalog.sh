...
#                              Default: ${HOME}/.config/opencode/plugins/marketplaces
#   YCC_MCP_LIBRARY_DOC      — path to an MCP library AGENTS.md
#                              Default: ${HOME}/.config/opencode/mcp-library/AGENTS.md
#
...
# ---------------------------------------------------------------------------
MARKETPLACE_DIR="${YCC_MCP_MARKETPLACE_DIR:-${HOME}/.config/opencode/plugins/marketplaces}"
MCP_LIBRARY_DOC="${YCC_MCP_LIBRARY_DOC:-${HOME}/.config/opencode/mcp-library/AGENTS.md}"
...
if [[ "$marketplace_ok" == "true" ]]; then
    for dir in "$MARKETPLACE_DIR"/*/; do
        [[ -d "$dir" ]] || continue
        plugin_json="$dir/.opencode-plugin/plugin.json"
...
# Parse MCP library AGENTS.md for additional MCPs
