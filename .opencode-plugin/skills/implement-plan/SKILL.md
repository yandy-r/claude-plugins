...
description: Execute a parallel implementation plan by deploying implementor agents
  ...
  dependency wiring. Worktree isolation is ON by default; pass --no-worktree to opt
  out. --worktree is accepted as a legacy no-op. Use as Step 3 after parallel-plan.
---
