...
| Field                | Value                                                                          |
| -------------------- | ------------------------------------------------------------------------------ |
| Path                 | `.opencode-plugin/skills/<kebab-name>/SKILL.md`                                             |
...
command under `.opencode-plugin/commands/` — typically because it's a passive behavioral
...
| Field                | Value                                             |
| -------------------- | ------------------------------------------------- |
| Path                 | `.opencode-plugin/commands/<kebab-name>.md`                    |
...
Many commands grow beyond the minimal form — see `.opencode-plugin/commands/plan.md` or
`.opencode-plugin/commands/ask.md` for examples with flag tables, cross-refs, or agent pinning.
...
| Field       | Value                                                    |
| ----------- | -------------------------------------------------------- |
| Path        | `.opencode-plugin/skills/_shared/scripts/<kebab-name>.sh`             |
...
chmod +x .opencode-plugin/skills/<name>/scripts/*.sh
```
