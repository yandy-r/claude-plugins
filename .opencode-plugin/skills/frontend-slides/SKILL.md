...
Before generating, read `~/.config/opencode/skills/frontend-slides/references/style-presets.md` for the viewport-safe CSS base, density limits, preset catalog, and CSS gotchas.
...
Use the preset guide in `~/.config/opencode/skills/frontend-slides/references/style-presets.md` when mapping mood to style.
