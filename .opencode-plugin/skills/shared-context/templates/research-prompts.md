...
3. **Create team** - Use spawn coordinated subagents with name `sc-[feature-name]`
4. **Create tasks** - Use track the task to create 4 research tasks
5. **Spawn in parallel** - Use a single message with 4 parallel subagent invocations, each with `team_name` and `name`
