...
- Validate your commit message BEFORE committing:
  ```bash
  ~/.config/opencode/skills/git-workflow/scripts/validate-commit.sh "<your-commit-message>"
````
...
Refer to: ~/.config/opencode/skills/git-workflow/templates/documentation-decision.md
...
**Command**: Single subagent invocation with one docs-git-committer agent
...
**CRITICAL**: Deploy ALL agents in SINGLE message with MULTIPLE parallel subagent invocations

**Example**:

```

[Single message with 3 parallel subagent invocations]
