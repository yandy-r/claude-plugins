...
**Template**: `~/.config/opencode/file-templates/feature-doc.template.md`
...
**AGENTS.md updates are RARELY NEEDED**. Most code changes do NOT warrant AGENTS.md updates.

**NEVER update the root AGENTS.md** - only update AGENTS.md files in specific directories.
...
1. **Root AGENTS.md**
   - **NEVER** update the root AGENTS.md
...
3. **Verbose explanations**
   - AGENTS.md should be under 50 lines per file
...
5. **Most changes**
   - 95% of changes don't need AGENTS.md updates
   - When in doubt, skip it
   - Over-documenting in AGENTS.md dilutes critical info
...
(This belongs in feature docs, not AGENTS.md)
````

### AGENTS.md Template Location

**Template**: `~/.config/opencode/file-templates/agents.template.md`
...
**Template**: `~/.config/opencode/file-templates/arch.template.md`
...
**Template**: `~/.config/opencode/file-templates/api.template.md`
...
**Template**: `~/.config/opencode/file-templates/setup.template.md`
...
- **Current developers** → AGENTS.md (rarely) or feature docs
...
- **Security-critical** → AGENTS.md (if directory-specific)
- **Must not be forgotten** → AGENTS.md or architecture docs
...
| Change Type         | Feature Docs | AGENTS.md | Architecture Docs     | API Docs          |
| ------------------- | ------------ | --------- | --------------------- | ----------------- |
...
- ❌ AGENTS.md: Not needed (standard pattern)
...
- ❌ AGENTS.md: Obvious organizational change
...
- 🟡 AGENTS.md: Maybe in `auth/` directory if critical
...
- [ ] Is this a critical directory-specific pattern? → AGENTS.md (rarely)
...
**Remember**: AGENTS.md updates are RARELY needed. Most changes go in feature docs or are too minor to document at all.
