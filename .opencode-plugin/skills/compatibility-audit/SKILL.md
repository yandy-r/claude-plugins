...
```
~/.config/opencode/shared/scripts/report-bundle-drift.sh --target=<t> --format=json
```
...
```
~/.config/opencode/skills/compatibility-audit/scripts/audit-install-assumptions.sh --target=<t> --format=json
```
...
```
~/.config/opencode/skills/compatibility-audit/scripts/audit-target-features.sh
```
...
`~/.config/opencode/skills/compatibility-audit/references/reading-the-report.md`.
