...
Run `~/.config/opencode/skills/bundle-release/scripts/preflight.sh`. On non-zero
...
- Version parity: `ycc/.opencode-plugin/plugin.json` and `.opencode-plugin/marketplace.json`
...
Read `~/.config/opencode/skills/bundle-release/references/version-policy.md`.
...
- Files that will be modified (`ycc/.opencode-plugin/plugin.json`,
...
Run `~/.config/opencode/skills/bundle-release/scripts/bump-version.sh <new-version>`.

This script updates both hand-edited JSON files atomically. After it exits, surface the
diff (`git diff ycc/.opencode-plugin/plugin.json .opencode-plugin/marketplace.json`) for
...
```
git checkout -- ycc/.opencode-plugin/plugin.json .opencode-plugin/marketplace.json .opencode-plugin/ && ./scripts/sync.sh
```
...
```
~/.config/opencode/skills/bundle-release/scripts/draft-notes.sh <new-version>
```
