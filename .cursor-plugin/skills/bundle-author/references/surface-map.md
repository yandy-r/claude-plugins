...
```
${CURSOR_PLUGIN_ROOT}/skills/<kebab-name>/scripts/<name>.sh
${CURSOR_PLUGIN_ROOT}/skills/<kebab-name>/references/<name>.md
```
...
| Sourced via | `${CURSOR_PLUGIN_ROOT}/skills/_shared/scripts/<name>.sh` |
