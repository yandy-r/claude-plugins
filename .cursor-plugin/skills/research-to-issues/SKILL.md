...
| prd           | `${CURSOR_PLUGIN_ROOT}/skills/research-to-issues/references/parse-prd.md`           |
...
| -------------------------------- | ---------------------------------------------------------------------------- |
| deep-research, feature-spec, prd | `${CURSOR_PLUGIN_ROOT}/skills/research-to-issues/templates/feature-issue.md` |
