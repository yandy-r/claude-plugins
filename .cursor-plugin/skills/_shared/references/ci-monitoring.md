...
Consumed by `git-workflow` (Phase 6) and `prp-pr` (Phase 7) when the
...
`${CURSOR_PLUGIN_ROOT}/skills/_shared/scripts/ci-monitor.sh`. This document and
...
- `${CURSOR_PLUGIN_ROOT}/skills/_shared/scripts/ci-monitor.sh` — loop execution script
- `${CURSOR_PLUGIN_ROOT}/skills/git-workflow/SKILL.md` — Phase 6 (CI monitoring loop)
- `${CURSOR_PLUGIN_ROOT}/skills/prp-pr/SKILL.md` — Phase 7 (CI monitoring loop)
