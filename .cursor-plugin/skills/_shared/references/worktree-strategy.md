...
| Property   | Value                                                                 |
| ---------- | --------------------------------------------------------------------- |
| Path       | `<repo-root>/.cursor/worktrees/<repo>-<feature>/`                     |
...
`<repo-root>/.cursor/worktrees/` so each runtime stays inside the managed
...
The feature worktree remains at `<repo-root>/.cursor/worktrees/<repo>-<feature>/` after the
