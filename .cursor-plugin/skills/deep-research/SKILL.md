...
**CRITICAL**: Deploy all 8 persona agents in a **SINGLE message** with **MULTIPLE parallel agent invocations**. No `team_name` — standalone dispatch.
...
**CRITICAL**: Deploy both analysis agents in a **SINGLE message** with **MULTIPLE parallel agent invocations**. No `team_name`.
...
**CRITICAL**: Deploy all 4 strategic analysis agents in a **SINGLE message** with **MULTIPLE parallel agent invocations**. No `team_name`.
