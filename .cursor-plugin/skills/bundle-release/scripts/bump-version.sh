...
#
# Updates:
#   - ycc/.cursor-plugin/plugin.json (.version)
...
print(f"ycc/.cursor-plugin/plugin.json:       {old_plugin} -> {new_version}")
print(f".cursor-plugin/marketplace.json meta: {old_meta} -> {new_version}")
print(f".cursor-plugin/marketplace.json entry: {old_entry} -> {new_version}")
PY
