...
#                              Default: ${HOME}/.cursor/plugins/marketplaces
#   YCC_MCP_LIBRARY_DOC      — path to an MCP library CLAUDE.md
#                              Default: ${HOME}/.cursor/mcp-library/CLAUDE.md
#
...
# ---------------------------------------------------------------------------
MARKETPLACE_DIR="${YCC_MCP_MARKETPLACE_DIR:-${HOME}/.cursor/plugins/marketplaces}"
MCP_LIBRARY_DOC="${YCC_MCP_LIBRARY_DOC:-${HOME}/.cursor/mcp-library/CLAUDE.md}"
