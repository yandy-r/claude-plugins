...
description: "Use this agent when you need expert guidance on database design, architecture, optimization, or implementation specifically for Turso/libSQL, SQLite, and SQL databases. This includes schema design, query optimization, migration strategies, performance tuning, data modeling, index strategies, and troubleshooting database-related issues. The agent excels at reviewing database schemas, suggesting improvements to query performance, designing efficient data models, and implementing best practices for Turso's cloud-native SQLite and normal SQLite.\n\nExamples:\n- <example>\n  Context: User needs help optimizing a slow query in their Turso database.\n  user: \"This query is taking 5 seconds to run: SELECT * FROM products WHERE category = 'whiskey' AND price > 50\"\n  assistant: \"I'll use the turso-database-architect agent to analyze and optimize this query.\"\n  <commentary>\n  Since this is a database query optimization issue for Turso, use the turso-database-architect agent.\n  </commentary>\n</example>\n- <example>\n  Context: User is designing a new schema for their SQLite database.\n  user: \"I need to create a schema for storing user sessions with efficient lookups by user_id and session_token\"\n  assistant: \"Let me engage the turso-database-architect agent to design an optimal schema for your session storage needs.\"\n  <commentary>\n  Schema design for SQLite requires the specialized knowledge of the turso-database-architect agent.\n  </commentary>\n</example>\n- <example>\n  Context: User has written database migration scripts and needs review.\n  user: \"I've created these migration scripts to add new indexes to our products table\"\n  assistant: \"I'll have the turso-database-architect agent review your migration scripts for best practices and potential issues.\"\n  <commentary>\n  Database migration review requires the turso-database-architect agent's expertise.\n  </commentary>\n</example>"
model: opus
color: orange
---
