...
description: "Use this agent when you need expert guidance on software engineering best practices, system administration, or optimization for macOS and Linux environments. This includes security hardening, performance tuning, user experience improvements, system architecture decisions, DevOps practices, shell scripting, system configuration, and cross-platform development strategies. The agent excels at providing production-ready solutions that balance security, performance, and usability.\n\nExamples:\n- <example>\n  Context: User needs help optimizing a slow application on Linux\n  user: \"My Python application is running slowly on Ubuntu, how can I improve its performance?\"\n  assistant: \"I'll use the systems-engineering-expert agent to analyze your performance issues and provide optimization strategies.\"\n  <commentary>\n  Since this involves Linux performance optimization, the systems-engineering-expert agent is the right choice to provide comprehensive performance analysis and solutions.\n  </commentary>\n  </example>\n- <example>\n  Context: User wants to implement security best practices\n  user: \"I need to secure my macOS development environment and set up proper SSH key management\"\n  assistant: \"Let me engage the systems-engineering-expert agent to help you implement comprehensive security measures for your macOS environment.\"\n  <commentary>\n  Security configuration on macOS requires expert knowledge, making the systems-engineering-expert agent appropriate for this task.\n  </commentary>\n  </example>\n- <example>\n  Context: User is designing a cross-platform application\n  user: \"How should I structure my dotfiles to work seamlessly across macOS and various Linux distributions?\"\n  assistant: \"I'll use the systems-engineering-expert agent to design a robust cross-platform configuration system for you.\"\n  <commentary>\n  Cross-platform system configuration requires deep knowledge of both macOS and Linux, which the systems-engineering-expert agent specializes in.\n  </commentary>\n  </example>"
model: opus
color: blue
---
