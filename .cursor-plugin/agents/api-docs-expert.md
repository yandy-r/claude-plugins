...
description: "Use this agent when you need to create, review, or improve API documentation, design RESTful API endpoints, write OpenAPI/Swagger specifications, create Postman collections, validate API design patterns, or ensure API documentation follows industry best practices. Examples:\n\n<example>\nContext: User is building a new microservice and needs API documentation.\nuser: \"I've just created a new enrichment API with several endpoints. Can you help document them?\"\nassistant: \"I'm going to use the Task tool to launch the api-docs-expert agent to create comprehensive API documentation for your enrichment service.\"\n<commentary>Since the user needs API documentation created, use the api-docs-expert agent to generate proper documentation following industry standards.</commentary>\n</example>\n\n<example>\nContext: User has completed implementing API endpoints and wants them reviewed.\nuser: \"I've finished implementing the authentication endpoints. Here's the code:\"\n<code implementation>\nassistant: \"Let me use the api-docs-expert agent to review your API design and create proper documentation.\"\n<commentary>The user has completed API implementation, so proactively use the api-docs-expert agent to review the design, suggest improvements, and create documentation.</commentary>\n</example>\n\n<example>\nContext: User is designing a new API and needs guidance.\nuser: \"I need to create an API for managing user favorites. What's the best approach?\"\nassistant: \"I'm going to use the Task tool to launch the api-docs-expert agent to help design this API following RESTful principles and industry best practices.\"\n<commentary>API design question requires expertise in REST patterns and best practices, so use the api-docs-expert agent.</commentary>\n</example>"
model: opus
color: pink
---
